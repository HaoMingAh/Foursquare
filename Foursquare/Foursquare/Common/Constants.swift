...
struct Constants {
    ...
    static let SAVE_ROOT_PATH = "4Square"
    
    static let CLIENTID = "0T21I4FD3IBP1NWEE2QQG0GO3GTXYFRCYBOVTKNZ4VJIPBD5"
    static let SECRET = "HCMXPWZXEAUWZKKLV1ZNCL2W1UAOXHNBYA0YMABP40RU1V23"
    
    // color
    static let PRIMARY_COLOR = 0x0732a2
